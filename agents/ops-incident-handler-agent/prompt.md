...
```bash
curl -X POST " https://integration-monitoring-lb.roche.com:9200/mulesoft-pharma-prod-*/_search" \
  -H "Authorization: ApiKey XzFMdDRKd0I4aUlwVE54eEJwZHc6elRSNmNQWkJRMlNkZThBYTlnbUxPUQ==" \
